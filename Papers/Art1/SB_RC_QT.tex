\documentclass[reprint,aps,onecolumn,pra,notitlepage,nofootinbib]{revtex4-1}
%------------------------------------------------------------
%% Begin Preamble
%------------------------------------------------------------
%% Language and font encodings
\usepackage[english]{babel}	% spanish for default (tittles of tables, figures, etc).
\usepackage[utf8]{inputenc}% utf8 for write with accents directlty from the keyboard: ñ,á,è,...
\usepackage[T1]{fontenc}	% allows the user to select font encodings (copy, paste, search text)
\usepackage{lmodern}		% to improvement of the special characters. For example, to copy and paste correctly from the final PDF document.https://es.overleaf.com/project/6026ab0f6b408d7ceab88c98

%% Math writing
\usepackage{amsmath}
\usepackage[makeroom]{cancel}		% principal set of math characters of the American Mathematical Society (AMS)
\usepackage{amsfonts}		% extended set of math characters of the AMS
\usepackage{amssymb}		% symbols of the AMS
\usepackage{mathrsfs}		% better appearance for math symbols
\usepackage{bbm}% bold math
\usepackage{amsthm}			% to use proof environment
%\usepackage{dsfont}			% to simbols of matrix symbols (\mathbb{1}$) and mathbfmatrix symbols (\mathds{1})
...
% adds an optional argument to the enumerate environment
...
%\newcommand{\braket}[2]{\ensuremath{\left\langle#1\left|\left. #2 \right\rangle\right.\right.}}

%\usepackage{pstricks}	    % Contain the most of the PSTricks commands.
...
%\usepackage{pst-plot}	    % to 2D plots with data lists or graph of functions.
%\usepackage{pst-eucl}	    % to geometric forms
%
% (it's recommended import the 'graphics' package after 'PSTricks' package).
...
\usepackage[letterpaper,left=3cm,right=2.5cm,top=2.5cm,bottom=2.5cm,marginparwidth=1.75cm]{geometry}
%------------------------------------------------------------
...
\newcommand{\dbar}{\mathchar'26\mkern-12mu d}			% dbar
\newcommand{\C}{\mathbb{C}} 							% C to complex numbers
...
%    \author{Oscar David Hernández}
%    \email{osdhernandezpa@unal.edu.co}
